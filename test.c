...
#include "fufs/filesystem.h"
#include "fufs/superblock.h"
#include "fufs/data_block.h"
#include "fufs/inode.h"
#include "fufs/base_file.h"
#include "fufs/base_block_file.h"
#include "fs.h"
#include "utils/log.h"
...
bool test_fs(void)
{
    ...
    TEST_ASSERT(fs_mount(device, 'A', FS_TYPE_FUFS));
